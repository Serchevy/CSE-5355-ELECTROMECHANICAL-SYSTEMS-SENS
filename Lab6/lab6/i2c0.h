...
void writeI2c0Registers(uint8_t add, uint8_t reg, const uint8_t data[], uint8_t size);  // Write to several registers. Take data from array of data
...
bool isI2c0Error(void);             // after every commnad, this function can check for an error
